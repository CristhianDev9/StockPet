<?php
    ...
    $actualizar_usuario = $actualizar_usuario->prepare("UPDATE usuario SET usuario_nombre=:nombre, usuario_apellido=:apellido, usuario_cargo=:cargo, usuario_usuario=:usuario, usuario_clave=:clave, usuario_email=:email, usuario_rol=:rol WHERE usuario_id=:id");
    ...
    if ($actualizar_usuario->execute($marcadores)) {
        echo '
            ...
            <script>
                document.querySelector(".alert").style.display = "block";
                setTimeout(function() {
                    window.location.href = "/inventario/index.php?vista=user_list";
                }, 3000);
            </script>
        ';
    } else {
